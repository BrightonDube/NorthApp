...
async def test_user_firmness_caching():
    ...
    mock_client.from_.return_value.select.return_value.eq.return_value.single.return_value.execute.return_value = mock_result
...
async def test_embedding_caching():
    ...
    mock_response.embeddings = [[0.1] * 1024]  # Mock embedding vector
