...
-- Description: Updates existing coaches with Socratic approach and guardrails, adds Leadership & Fitness coaches
...
-- Insert NEW Leadership & EQ Coach
INSERT INTO coaches (
  id,
  name,
  icon,
...
-- Insert NEW Fitness & Wellness Coach
INSERT INTO coaches (
  id,
  name,
  icon,
...
-- Success message
SELECT 'Default coaches created successfully with Socratic approach and guardrails' AS message;
